...
const signalRows: Array<{ key: PreferenceKey; title: string; detail: string }> = [
...
const productRows: Array<{ key: PreferenceKey; title: string; detail: string }> = [
...
const surfaceRows: Array<{ key: PreferenceKey; title: string; detail: string }> = [
...
const styles = StyleSheet.create({
  ...
  intelligenceNote: { padding: 14, marginBottom: 8, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(115,233,251,.12)', backgroundColor: 'rgba(115,233,251,.035)' },
  intelligenceTitle: { color: FateDropColors.text, fontSize: 11, fontWeight: '900' },
  intelligenceCopy: { color: FateDropColors.secondary, fontSize: 9, lineHeight: 14, marginTop: 4 },
