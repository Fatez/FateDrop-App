...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: FateDropColors.goldBright, fontFamily: Fonts.bold, fontSize: 10, letterSpacing: 1.1 },
  title: { color: FateDropColors.ivory, fontFamily: Fonts.bold, fontSize: 28, letterSpacing: -0.7, marginTop: 3 },
  ...
  introTitle: { color: FateDropColors.ivory, fontFamily: Fonts.bold, fontSize: 15 },
  introCopy: { color: FateDropColors.muted, fontFamily: Fonts.regular, fontSize: 12, lineHeight: 18, marginTop: 5 },
  sectionHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 6, marginBottom: 10 },
  sectionEyebrow: { color: FateDropColors.muted, fontFamily: Fonts.bold, fontSize: 10, letterSpacing: 1 },
  sectionCount: { color: FateDropColors.muted, fontFamily: Fonts.bold, fontSize: 11 },
  ...
  emptyTitle: { color: FateDropColors.ivory, fontFamily: Fonts.bold, fontSize: 14 },
  emptyCopy: { color: FateDropColors.muted, fontFamily: Fonts.regular, fontSize: 12, lineHeight: 18, marginTop: 5 },
  ...
  stageText: { fontFamily: Fonts.bold, fontSize: 9, letterSpacing: 0.7 },
  stock: { color: FateDropColors.muted, fontFamily: Fonts.bold, fontSize: 10 },
  alertTitle: { color: FateDropColors.ivory, fontFamily: Fonts.bold, fontSize: 15, lineHeight: 20, marginTop: 10 },
  expectedLabel: { color: FateDropColors.goldBright, fontFamily: Fonts.bold, fontSize: 12, marginTop: 8 },
  expectedWindow: { color: FateDropColors.ivory, fontFamily: Fonts.regular, fontSize: 12, marginTop: 3 },
  alertFoot: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginTop: 11 },
  detected: { flex: 1, color: FateDropColors.muted, fontFamily: Fonts.regular, fontSize: 10 },
