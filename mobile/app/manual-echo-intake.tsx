...
export default function ManualEchoIntakeScreen() {
  ...
  return <SafeAreaView style={styles.safe} edges={['top']}><FateDropBackground/><ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
    ...
    <Pressable onPress={() => router.push('/manual-echo-retractions')} style={styles.retract}><Text style={styles.retractText}>MANAGE / RETRACT ACTIVE ECHOES</Text><Ionicons name="trash-outline" size={15} color={FateDropColors.vanished}/></Pressable>
