  ...
  return (
    <>
      ...
      <Modal transparent visible={compassOpen} animationType="fade" onRequestClose={() => setCompassOpen(false)}>
        <Pressable accessibilityViewIsModal style={styles.compassBackdrop} onPress={() => setCompassOpen(false)}>
          ...
          <Pressable style={styles.compassStage} onPress={() => undefined}>
            ...
            <Pressable
              ...
              <Text style={styles.fateFindEyebrow}>CENTRE</Text>
              <Text style={styles.fateFindTitle}>FateFind</Text>
              <Text style={styles.fateFindDetail}>Hunt it now</Text>
            </Pressable>
          </Pressable>
...
const styles = StyleSheet.create({
  ...
  compassBackdrop: { flex: 1, justifyContent: 'flex-end', alignItems: 'center', backgroundColor: 'rgba(2,5,9,.84)' },
