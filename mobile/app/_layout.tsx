...
function FateDropShell() {
  ...
  return <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
    <Stack>
      ...
      <Stack.Screen name="fate-price-set" options={{ headerShown: false }} />
      <Stack.Screen name="fate-price-variants" options={{ headerShown: false }} />
      <Stack.Screen name="fate-price-buy" options={{ headerShown: false }} />
      <Stack.Screen name="collection" options={{ headerShown: false }} />
      <Stack.Screen name="collections" options={{ headerShown: false }} />
      <Stack.Screen name="binders" options={{ headerShown: false }} />
