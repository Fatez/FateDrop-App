...
const guideSlides = [
  ...
  },
  {
    ...
    body: 'Search finds products and retailers. FateFind compares the live opportunity with True Price evidence and lets you set the conditions worth watching. A successful watched result becomes a FateMatch.',
    action: 'Alerts describe network signals separately. Local Radar handles physical-store intelligence separately again.',
    accent: FateDropColors.violetLight,
    source: require('@/assets/images/home-koru-hero.webp'),
  },
  {
