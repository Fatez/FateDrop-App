...
export const profileAvatarSources: Record<Exclude<ProfileAvatarId, 'mark'>, ImageSource> = {
...
export const profileWallpaperSources: Record<ProfileWallpaperId, ImageSource> = {
