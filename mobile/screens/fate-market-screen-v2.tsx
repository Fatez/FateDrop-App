...
const styles = StyleSheet.create({
  ...
  marketGuardians: { display: 'none', position: 'absolute', left: 0, right: 0, top: 0, width: '100%', height: 520, opacity: 0 },
  marketGuardianVeil: { display: 'none', position: 'absolute', left: 0, top: 0, width: '67%', height: 520, backgroundColor: 'transparent' },
