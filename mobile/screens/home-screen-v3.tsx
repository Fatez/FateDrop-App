...
const styles = StyleSheet.create({
  ...
  lifecycleArcOuter: { position: 'absolute', width: '116%', height: 92, left: '-8%', top: -5, borderRadius: 999, borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(226,197,141,.60)' },
  lifecycleArcInner: { position: 'absolute', width: '116%', height: 92, left: '-8%', top: 5, borderRadius: 999, borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(226,197,141,.32)' },
  lifecycleArcCrown: { position: 'absolute', left: '50%', top: 0, width: 14, height: 14, marginLeft: -7, alignItems: 'center', justifyContent: 'center' },
