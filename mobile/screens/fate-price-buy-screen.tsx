...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: FateDropColors.goldBright, fontSize: 11, fontWeight: '900', letterSpacing: 1.45 },
  ...
  copy: { color: FateDropColors.secondary, fontSize: 11, lineHeight: 16, marginTop: 8 },
  ...
  cardMeta: { color: FateDropColors.secondary, fontSize: 11, marginTop: 4 },
  cardVariant: { color: FateDropColors.muted, fontSize: 11, lineHeight: 16, marginTop: 4 },
  priceBlock: { width: 83, alignItems: 'flex-end' },
  priceLabel: { color: FateDropColors.goldBright, fontSize: 11, fontWeight: '900', letterSpacing: .55 },
  priceValue: { color: FateDropColors.ivory, fontFamily: Fonts.serif, fontSize: 21, marginTop: 3 },
  fairRange: { color: FateDropColors.muted, fontSize: 11, marginTop: 3 },
  ...
  tabText: { color: FateDropColors.muted, fontSize: 11, fontWeight: '900', letterSpacing: .55 },
  ...
  filterEyebrow: { color: FateDropColors.goldBright, fontSize: 11, fontWeight: '900', letterSpacing: 1.1 },
  offerCount: { color: FateDropColors.muted, fontSize: 11, fontWeight: '900', letterSpacing: .55 },
  ...
  notice: { color: FateDropColors.secondary, fontSize: 11, lineHeight: 16, marginTop: 10 },
  loading: { minHeight: 250, alignItems: 'center', justifyContent: 'center', gap: 10 },
  loadingText: { color: FateDropColors.muted, fontSize: 11 },
  ...
  emptyCopy: { color: FateDropColors.secondary, fontSize: 11, lineHeight: 16, textAlign: 'center', marginTop: 7 },
  ...
  findButtonText: { color: '#080B14', fontSize: 11, fontWeight: '900', letterSpacing: .7 },
  ...
  rankingTruthText: { flex: 1, color: FateDropColors.secondary, fontSize: 11, lineHeight: 16 },
  ...
  lowestBadgeText: { color: FateDropColors.background, fontSize: 11, fontWeight: '900', letterSpacing: .55 },
  ...
  offerTitle: { color: FateDropColors.secondary, fontSize: 11, lineHeight: 16, marginTop: 3 },
  ...
  verdictText: { fontSize: 11, fontWeight: '900', letterSpacing: .5 },
  ...
  priceCellLabel: { color: FateDropColors.muted, fontSize: 11, fontWeight: '900', letterSpacing: .55 },
  ...
  comparisonCopy: { flex: 1, color: FateDropColors.secondary, fontSize: 11, lineHeight: 16 },
  offerFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 9 },
  stockCopy: { flex: 1 },
  stock: { color: FateDropColors.goldBright, fontSize: 11, fontWeight: '900', letterSpacing: .5 },
  verifiedAt: { color: FateDropColors.muted, fontSize: 11, marginTop: 3 },
  viewButton: { minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 13, borderRadius: 999, backgroundColor: FateDropColors.goldBright },
  viewButtonText: { color: '#080B14', fontSize: 11, fontWeight: '900', letterSpacing: .55 },
});
