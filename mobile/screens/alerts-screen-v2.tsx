...
export default function AlertsScreenV2(){
  ...
  return <SafeAreaView style={styles.safe}><FateDropBackground/><ScrollView contentContainerStyle={styles.content}>
    ...
    }) : <Compact title={networkLoading?'Loading network activity…':'No lifecycle activity available'} text={networkError||'New Echo, Manifested and Vanished events will appear here from FateDrop Cloud.'}/>}</View>
